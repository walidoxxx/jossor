  ...
  return (
    <main className="container" style={{ padding: "60px 0" }} dir="rtl">
      <div className="card" style={{ maxWidth: 760, margin: "0 auto", padding: 40, textAlign: "center" }}>
        ...
        <p className="muted">رقم ملف الأسرة: <strong>#{number}</strong></p>
        ...
        <button className="btn btn-ghost" onClick={() => navigate("/inscription")} disabled={busy}>تسجيل ملف أسرة آخر</button>
      </div>
    </main>
  );
}